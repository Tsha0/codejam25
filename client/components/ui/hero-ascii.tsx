...
function TypingTestPopover() {
  const testSentences = [
    ...
    "Test everything and trust nothing blindly",
    "Documentation is as important as code",
    "Collaboration makes the dream work together"
  ];
